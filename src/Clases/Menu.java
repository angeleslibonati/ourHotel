...
public class Menu {
    ...
    public static void MenuAbmReserva (Scanner scan,ArrayList<Persona>personas){
        ...
        switch (opc){
            ...
            case 5:
                ...
                encabezadoMenu("Todas las Reserva");
    ...
    public static void imprimirAbmReserva (){
        ...
        centradoOpciones("5. Ver todas Reserva");
        dibujarTerminacion();
    }
    ...
    public static void imprimirMenuReserva (){
        ...
        dibujarTerminacion();
        encabezadoMenu("Sistema Reserva");
        centradoOpciones("1. Realizar Reserva");
        centradoOpciones("2. Cancelar Reserva");
        centradoOpciones("3. Ver Reserva Activas");
        centradoOpciones("4. Historico de Reserva");
        centradoOpciones("0. Volver Atras");
        dibujarTerminacion();
    }
